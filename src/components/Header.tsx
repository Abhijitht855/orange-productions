...
//                   ) : (
//                     <FiSearch className="w-6 h-6 text-gray-800 cursor-pointer" />
//                   )}
//                 </div>
//               </button>
//             </div>
...
//               <div className="absolute inset-x-0 top-[100%] bg-white shadow-2xl border border-gray-200 px-6 xl:px-32 py-8 w-full z-50">
//                 <div className="flex gap-4">
//                   {/* Categories (4 columns) */}
//                   <div className="grid grid-cols-1 gap-4 md:grid-cols-1 lg:grid-cols-4 flex-1">
//                     {Object.entries(dropdownMenus[activeDropdown]!.categories).map(([category, data]) => (
//                       <div key={category}>
//                         <h3 className="font-bold text-gray-800 mb-3 text-sm border-b border-gray-300 pb-1">
//                           {category}
//                         </h3>
...
//                       }}
//                     >
//                       {Object.entries(dropdownMenus[activeDropdown]!.categories).map(
//                         ([category, data]) => (
//                           <motion.div
//                             key={category}
...
//                             <Image
//                               src={
//                                 (hoveredSubItem || defaultSubItem)!.image ||
...
//                               <a
//                                 href={`/category/${category}`} // replace with your route logic
//                                 className="flex items-center font-semibold text-gray-800 text-sm uppercase tracking-wide mb-3 hover:text-[#E7671E] transition-colors"
//                               >
//                                 {category}
...
//                 <div className="bg-white shadow-2xl border border-gray-200 px-6 xl:px-32 py-8 w-full">
//                   <a
//                     href={`/category/${encodeURIComponent(activeDropdown)}`}
//                     className="block text-lg font-bold text-gray-900 mb-6 border-b border-gray-200 pb-2 hover:text-[#E7671E] transition-colors"
//                   >
//                     {activeDropdown}
//                   </a>
//                   <motion.div
...
//                           transition={{ duration: 0.3 }}
//                         >
//                           {/* Clickable Category Header with Icon */}
//                           <a
//                             href={`/category/${category}`}
//                             className="flex items-center font-bold text-gray-800 mb-3 text-sm border-b border-gray-300 pb-1 hover:text-[#E7671E] transition-colors"
//                           >
...
//               transition={{ duration: 0.3 }}
//               style={{
//                 backdropFilter: activeDropdown ? 'blur(40px)' : 'none',
//                 WebkitBackdropFilter: activeDropdown ? 'blur(40px)' : 'none',
//                 top: '104px',
